      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex items-center gap-4">
          ...
          <div>
            ...
            <h3 className="text-xl font-bold text-slate-800">{courses.filter(c => c.progress < 100).length * 2.5} Hours</h3>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-purple-600 to-indigo-700 rounded-3xl p-8 text-white shadow-xl mt-8">
            ...
            <p className="text-purple-100 text-xs leading-relaxed mb-6">
              {courses.length > 0 ? (
                `Based on your progress in '${courses[0].title}', I recommend exploring advanced topics in ${courses[0].category} to round out your profile.`
              ) : (
                "Enroll in your first course to get personalized AI career roadmap recommendations."
              )}
            </p>
