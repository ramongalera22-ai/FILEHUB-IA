...
const CURATED: Property[] = [
    {id:'c1',title:'Ático Milà i Fontanals, Vila de Gràcia',price:'1.200€',location:'Vila de Gràcia',sqm:45,rooms:0,baths:0,description:'Terraza grande >30m²',rawText:'',timestamp:Date.now(),source:'curated',sent:false,url:'https://www.idealista.com/alquiler-viviendas/barcelona/gracia/con-precio-hasta_1400,precio-desde_850/?ordenado-por=precios-asc',destacado:true,extras:['Ascensor','TERRAZA 50m²','Cerca L3 Fontana'],planta:'4ª ext',zona:'Vila de Gràcia'},
    {id:'c2',title:'Piso Dos de Maig 211, Sagrada Família',price:'1.275€',location:'Sagrada Família',sqm:67,rooms:2,baths:1,description:'',rawText:'',timestamp:Date.now(),source:'curated',sent:false,url:'https://www.idealista.com/alquiler-viviendas/barcelona/eixample/con-precio-hasta_1400,precio-desde_850/?ordenado-por=precios-asc',destacado:true,extras:['Ascensor','Balcón','Cerca L5 Sagrada Familia'],planta:'4ª ext',zona:'Sagrada Família'},
    {id:'c3',title:'Piso Encarnació, Baix Guinardó',price:'1.268€',location:'Baix Guinardó',sqm:80,rooms:3,baths:1,description:'',rawText:'',timestamp:Date.now(),source:'curated',sent:false,url:'https://www.idealista.com/alquiler-viviendas/barcelona/horta-guinardo/con-precio-hasta_1400,precio-desde_850/?ordenado-por=precios-asc',destacado:true,extras:['Ascensor','Balcón','Cerca L5 El Coll/La Teixonera'],planta:'4ª ext',zona:'Baix Guinardó'},
    {id:'c4',title:"Piso Martí, Camp d'En Grassot",price:'1.329€',location:"Camp d'En Grassot",sqm:80,rooms:4,baths:1,description:'',rawText:'',timestamp:Date.now(),source:'curated',sent:false,url:'https://www.idealista.com/alquiler-viviendas/barcelona/gracia/con-precio-hasta_1400,precio-desde_850/?ordenado-por=precios-asc',destacado:true,extras:['Ascensor','Sin amueblar',"Cerca L5 Camp de l'Arpa"],planta:'2ª ext',zona:"Camp d'En Grassot"},
    {id:'c5',title:"Piso l'Alba, Vila de Gràcia",price:'1.125€',location:'Vila de Gràcia',sqm:68,rooms:4,baths:1,description:'',rawText:'',timestamp:Date.now(),source:'curated',sent:false,url:'https://www.idealista.com/alquiler-viviendas/barcelona/gracia/con-precio-hasta_1400,precio-desde_850/?ordenado-por=precios-asc',destacado:true,extras:['Balcón','Cerca L3 Fontana'],planta:'1ª ext',zona:'Vila de Gràcia'},
    {id:'c6',title:'Piso Torrent de les Flors, Vila de Gràcia',price:'1.250€',location:'Vila de Gràcia',sqm:49,rooms:1,baths:1,description:'',rawText:'',timestamp:Date.now(),source:'curated',sent:false,url:'https://www.idealista.com/alquiler-viviendas/barcelona/gracia/con-precio-hasta_1400,precio-desde_850/?ordenado-por=precios-asc',destacado:true,extras:['Ascensor','Balcón','Cerca L3 Joanic'],planta:'3ª ext',zona:'Vila de Gràcia'},
    {id:'c7',title:'Piso Rambla del Carmel',price:'1.150€',location:'El Carmel',sqm:70,rooms:2,baths:1,description:'',rawText:'',timestamp:Date.now(),source:'curated',sent:false,url:'https://www.idealista.com/alquiler-viviendas/barcelona/horta-guinardo/con-precio-hasta_1400,precio-desde_850/?ordenado-por=precios-asc',destacado:true,extras:['Balcón','Reformado','Cerca L5 El Coll'],planta:'2ª ext',zona:'El Carmel'},
    {id:'c8',title:'Piso Sant Dalmir, La Teixonera',price:'1.195€',location:'La Teixonera',sqm:80,rooms:2,baths:1,description:'',rawText:'',timestamp:Date.now(),source:'curated',sent:false,url:'https://www.idealista.com/alquiler-viviendas/barcelona/horta-guinardo/con-precio-hasta_1400,precio-desde_850/?ordenado-por=precios-asc',destacado:false,extras:['Ascensor','Cerca L5 Teixonera'],planta:'3ª ext',zona:'La Teixonera'},
    {id:'c9',title:'Piso Casanova, Antiga Esquerra Eixample',price:'940€',location:'Antiga Esquerra Eixample',sqm:62,rooms:2,baths:1,description:'',rawText:'',timestamp:Date.now(),source:'curated',sent:false,url:'https://www.idealista.com/alquiler-viviendas/barcelona/eixample/con-precio-hasta_1400,precio-desde_850/?ordenado-por=precios-asc',destacado:true,extras:['Balcón','Cerca L5 Hospital Clínic'],planta:'5ª ext',zona:'Antiga Esquerra Eixample'},
    {id:'c10',title:"Piso Camp d'En Grassot, Gràcia Nova",price:'941€',location:'Gràcia Nova',sqm:66,rooms:2,baths:1,description:'',rawText:'',timestamp:Date.now(),source:'curated',sent:false,url:'https://www.idealista.com/alquiler-viviendas/barcelona/gracia/con-precio-hasta_1400,precio-desde_850/?ordenado-por=precios-asc',destacado:false,extras:['Ascensor',"Cerca L5 Camp de l'Arpa"],planta:'Entreplanta ext',zona:'Gràcia Nova'},
    {id:'c11',title:'Piso Rosalia de Castro, Baix Guinardó',price:'1.150€',location:'Baix Guinardó',sqm:65,rooms:1,baths:1,description:'',rawText:'',timestamp:Date.now(),source:'curated',sent:false,url:'https://www.idealista.com/alquiler-viviendas/barcelona/horta-guinardo/con-precio-hasta_1400,precio-desde_850/?ordenado-por=precios-asc',destacado:false,extras:['Ascensor','Cerca L3/L5 Guinardó'],planta:'1ª ext',zona:'Baix Guinardó'},
    {id:'c12',title:'Piso Dante Alighieri, El Carmel',price:'950€',location:'El Carmel',sqm:55,rooms:2,baths:1,description:'',rawText:'',timestamp:Date.now(),source:'curated',sent:false,url:'https://www.idealista.com/alquiler-viviendas/barcelona/horta-guinardo/con-precio-hasta_1400,precio-desde_850/?ordenado-por=precios-asc',destacado:false,extras:['Ascensor','Cerca L5 El Carmel'],planta:'1ª ext',zona:'El Carmel'},
    {id:'c13',title:'Ático Conca de Tremp, El Carmel',price:'973€',location:'El Carmel',sqm:55,rooms:2,baths:0,description:'',rawText:'',timestamp:Date.now(),source:'curated',sent:false,url:'https://www.idealista.com/alquiler-viviendas/barcelona/horta-guinardo/con-precio-hasta_1400,precio-desde_850/?ordenado-por=precios-asc',destacado:false,extras:['Cerca L5 El Carmel'],planta:'4ª ext',zona:'El Carmel'},
    {id:'c14',title:'Piso València 54, Nova Esquerra Eixample',price:'1.125€',location:'Nova Esquerra Eixample',sqm:45,rooms:1,baths:1,description:'',rawText:'',timestamp:Date.now(),source:'curated',sent:false,url:'https://www.idealista.com/alquiler-viviendas/barcelona/eixample/con-precio-hasta_1400,precio-desde_850/?ordenado-por=precios-asc',destacado:true,extras:['Ascensor','Balcón','Cerca L5 Entença'],planta:'6ª ext',zona:'Nova Esquerra Eixample'},
    {id:'c15',title:'Piso Paseo Sant Joan, Dreta Eixample',price:'1.328€',location:'Dreta Eixample',sqm:56,rooms:2,baths:1,description:'',rawText:'',timestamp:Date.now(),source:'curated',sent:false,url:'https://www.idealista.com/alquiler-viviendas/barcelona/eixample/con-precio-hasta_1400,precio-desde_850/?ordenado-por=precios-asc',destacado:false,extras:['Ascensor','Cerca L5 Verdaguer'],planta:'1ª ext',zona:'Dreta Eixample'},
];
