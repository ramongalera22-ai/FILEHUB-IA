    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 p-4 sm:p-6 lg:p-8 custom-scrollbar overflow-y-auto">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">850\u20131400\u20ac \u00b7 L3/L5 Vall d\u2019Hebron \u00b7 &gt;35m\u00b2 \u00b7 No bajos \u00b7 Sin Raval/La Mina</p>
            </div>
          </div>
        ...
        <div className="mt-10 pt-6 border-t border-slate-200 dark:border-slate-700 text-center">
          ...
          <p className="text-[10px] text-slate-400 mt-1">FILEHUB \u00b7 850\u20131400\u20ac \u00b7 L3/L5 \u00b7 &gt;35m\u00b2 \u00b7 No bajos \u00b7 Sin Raval/La Mina</p>
        </div>
      </div>
    </div>
  );
