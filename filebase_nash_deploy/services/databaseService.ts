...
import { Expense, Project, Task, Goal, ShoppingItem, ShoppingOrder, CalendarEvent, Idea, OllamaConfig, OpenNotebookConfig, Debt, Investment, Presentation, SharedExpense, SharedDebt, WeightEntry, NutritionPlan, Trip, StoredFile } from '../types';
