...
const WorkView: React.FC<WorkViewProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'feed' | 'projects' | 'documents' | 'presentations' | 'knowledge'>('feed');
    ...
    <div className="space-y-10 animate-in fade-in duration-700 pb-20">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="flex bg-white p-1.5 rounded-2xl border border-slate-100 shadow-sm overflow-x-auto no-scrollbar gap-1">
          {[
            { id: 'feed', label: 'Resumen', icon: LayoutDashboard },
        ...
        <div className="space-y-10 animate-in fade-in duration-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-indigo-100 text-[10px] font-bold uppercase tracking-widest mt-2 flex items-center gap-2">
                  SLIDES & IA <ArrowUpRight size={14} />
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-emerald-100 text-[10px] font-bold uppercase tracking-widest mt-2 flex items-center gap-2">
                  NOTAS & ESTRATEGIA <ArrowUpRight size={14} />
                </p>
              </div>
            </div>
            ...
            >
              ...
              <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest mt-2 flex items-center gap-2">
                PROYECTOS MAESTROS <ArrowUpRight size={14} className="opacity-0 group-hover:opacity-100 transition-opacity" />
              </p>
            </div>
          </div>
          ...
          <section className="bg-white dark:bg-slate-900 rounded-[3rem] border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden">
            ...
            <div className="p-10 space-y-8">
              {/* Mock items for now as state is empty on load */}
      ...
      {activeTab === 'knowledge' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-10 rounded-[3rem] border border-slate-100 shadow-sm hover:border-indigo-200 transition-all group">
            ...
            <h3 className="text-2xl font-black text-slate-900 mb-2">Notebook Principal</h3>
            <p className="text-slate-500 text-sm font-medium mb-8">Acceso directo a tu libreta de trabajo principal mejorada por IA.</p>
            <a href={MAIN_NOTEBOOK_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-6 py-3 bg-slate-50 text-indigo-600 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-indigo-50 transition-all">
              Abrir Notebook IA <ExternalLink size={14} />
            </a>
          </div>

          <div className="bg-white p-10 rounded-[3rem] border border-slate-100 shadow-sm hover:border-blue-200 transition-all group">
            ...
            <p className="text-slate-500 text-sm font-medium mb-8">Accede a todos tus cuadernos de investigación en la nube.</p>
