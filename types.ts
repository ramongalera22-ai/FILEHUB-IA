...
export type ViewType = 'dashboard' | 'expenses' | 'calendar' | 'projects' | 'trips' | 'ai-coach' | 'fitness' | 'nutrition' | 'work' | 'tasks' | 'courses' | 'goals' | 'economy' | 'shopping' | 'qr' | 'ideas' | 'ai-hub' | 'settings' | 'shared-finances' | 'files' | 'shared-hub' | 'piso' | 'pisos-dashboard' | 'jobs' | 'activities' | 'whiteboard' | 'notebook' | 'openwebui' | 'car-mode' | 'news' | 'supermarkets' | 'whatsapp-bot' | 'whatsapp-pisos' | 'vip-tasks' | 'shifts' | 'work-planner' | 'habits' | 'budget-alerts' | 'cron-jobs' | 'time-block' | 'whatsapp-inbox' | 'travel-planner' | 'travel-notebook' | 'patient-notes' | 'hangouts';
